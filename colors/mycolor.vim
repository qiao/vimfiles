...
hi comment	cterm=none	ctermfg=green		ctermbg=none
hi constant	cterm=bold	ctermfg=yellow		ctermbg=none
hi error	cterm=none	ctermfg=white		ctermbg=red
hi identifier	cterm=none	ctermfg=yellow	ctermbg=none
hi ignore	cterm=none	ctermfg=darkgrey	ctermbg=none
hi preproc	cterm=none	ctermfg=yellow		ctermbg=none
...
hi type		cterm=bold	ctermfg=cyan	ctermbg=none
